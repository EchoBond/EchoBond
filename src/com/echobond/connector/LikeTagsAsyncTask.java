 ...
 * 
 */
public class LikeTagsAsyncTask extends AsyncTask<Object, Integer, JSONObject> {

	private LikeTagsCallback activity;
	@Override
	protected JSONObject doInBackground(Object... params) {
		String url = (String) params[0];
		activity =  (LikeTagsCallback) params[1];
	...
	protected void onPostExecute(JSONObject result) {
		...
		activity.onLikeTagFinished(result);
	}
