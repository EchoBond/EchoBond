	...
	public class FunctionOnClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			case POST:
				...
				break;
			case MESSAGE:
				if(SPUtil.get(SearchThoughtsResultFragment.this.getActivity(), MyApp.PREF_TYPE_LOGIN, MyApp.LOGIN_VERIFIED, 0, Integer.class).equals(0)){
					Toast.makeText(SearchThoughtsResultFragment.this.getActivity(), getResources().getString(R.string.hint_user_unverified), Toast.LENGTH_SHORT).show();
					return;
				}
